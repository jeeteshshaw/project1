...
const SignupController = async (req, res, next)=>{
    ...
    return res.send({status: "success", message:"Successfully Created New User", data: {token: newUser.createToken(newUser._id,"1234567890"), name: newUser.name, FirebaseToken: newUser.createToken(userRecord.uid)}})
}
